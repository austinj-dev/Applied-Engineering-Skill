...
description: "Applied Engineering by Austin Johnnic — 9-stage planning methodology for production-grade software. Generates 15-22 project documents so AI tools execute, not guess. 25+ question categories (50+ each), 19 stack references, 23 document templates, 7 tool configs. Supports Claude Code, Cursor, Windsurf, Lovable, Bolt, Replit Agent, Codex. Triggers: plan my build, implementation prompt, architecture planning, system design, tech stack evaluation, project planning, feature planning, or ANY request to systematically plan and build software. Never assume — always research. Never assume — always ask."
---
